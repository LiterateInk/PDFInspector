...
export const getDocument = (buffer: ArrayBuffer | ArrayBufferLike | Buffer): Promise<PDFDocumentProxy> => {
...
export class WorkerTransport {
  ...
  async fetchDocument (buffer: ArrayBuffer | ArrayBufferLike | Buffer): Promise<PDFDocumentProxy> {
