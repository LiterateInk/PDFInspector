...
export class FlateStream extends DecodeStream {
  ...
  static lengthDecode = new Uint32Array([
  ...
  static distDecode = new Uint32Array([
  ...
  static fixedLitCodeTab = [new Uint32Array([
  ...
  static fixedDistCodeTab = [new Uint32Array([
  ...
  readBlock () {
    ...
    if (hdr == 1) { // compressed block, fixed codes
      ...
      let codeLenCodeLengths = new Uint8Array(FlateStream.codeLenCodeMap.length);
      ...
      let codeLengths = new Uint8Array(codes);
      while (i < codes) {
